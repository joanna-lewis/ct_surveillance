...
150 Wokingham
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c}{\PYZsh{} plt.rc(\PYZdq{}savefig\PYZdq{}, dpi=300) \PYZsh{} for high\PYZhy{}resolution version}
        \PY{c}{\PYZsh{} Figure 2}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}6}]:} <matplotlib.text.Text at 0x113df05d0>
\end{Verbatim}
    \end{footnotesize}
...
/Library/Python/2.7/site-packages/matplotlib/\_\_init\_\_.py:878: UserWarning: axes.color\_cycle is deprecated and replaced with axes.prop\_cycle; please use the latter.
  warnings.warn(self.msg\_depr \% (key, alt\_key))
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:} <matplotlib.text.Text at 0x113f88890>
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} [<matplotlib.lines.Line2D at 0x113f8cf50>]
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:} [<matplotlib.lines.Line2D at 0x11727ff10>]
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:} <matplotlib.legend.Legend at 0x118c0ff10>
\end{Verbatim}
    \end{footnotesize}
...
no Isles of Scilly 00HF E06000053
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}14}]:} <matplotlib.text.Text at 0x119172150>
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}15}]:} <matplotlib.text.Text at 0x11ec89f10>
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}17}]:} <matplotlib.text.Text at 0x12455b710>
\end{Verbatim}
    \end{footnotesize}
...
{\color{incolor}In [{\color{incolor}18}]:} \PY{c}{\PYZsh{} Figure 10}
         ...
         \PY{c}{\PYZsh{}ax1.plot(0.005, 0.14, \PYZsq{}o\PYZsq{}, markerfacecolor=\PYZsq{}None\PYZsq{}, c=\PYZsq{}k\PYZsq{}) \PYZsh{} this line can be used to add \PYZsq{}x\PYZsq{} markers for the London Boroughs}
         \PY{c}{\PYZsh{}ax1.text(0.01, 0.14, \PYZsq{}Inner London boroughs\PYZsq{}, va=\PYZsq{}center\PYZsq{})}
\end{Verbatim}
    \end{footnotesize}

    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}18}]:} <matplotlib.text.Text at 0x128ae5610>
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}19}]:} <matplotlib.text.Text at 0x11f89fbd0>
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}20}]:} <matplotlib.text.Text at 0x129069d90>
\end{Verbatim}
    \end{footnotesize}
...
We also examine the relationship with prevalence:
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} Figure 13}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor} }]:} <matplotlib.text.Text at 0x12a0e27d0>
\end{Verbatim}
    \end{footnotesize}
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} Figure 14}
        \PY{c}{\PYZsh{} examine the Spearman correlation by sample}
        \PY{n}{spearman} \PY{o}{=} \PY{n}{empty}\PY{p}{(}\PY{p}{[}\PY{n}{n\PYZus{}sample}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{)}
...
screening in men vs.~women?
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} Figure 15}
