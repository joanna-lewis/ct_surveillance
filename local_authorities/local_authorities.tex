...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}6}]:} <matplotlib.text.Text at 0x10f427d50>
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:} <matplotlib.text.Text at 0x10ac8b990>
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} <matplotlib.legend.Legend at 0x10b885cd0>
\end{Verbatim}
    \end{footnotesize}
...
no Isles of Scilly 00HF E06000053
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:} <matplotlib.text.Text at 0x11343e990>
\end{Verbatim}
    \end{footnotesize}
...
We can also show local prevalence on a map:
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c}{\PYZsh{} Figure 7}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}13}]:} <matplotlib.text.Text at 0x1187ee710>
\end{Verbatim}
    \end{footnotesize}
