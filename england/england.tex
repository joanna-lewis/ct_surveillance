...
had started \textless{} 1, 1-2, 2-4, 4-6 and \textgreater{} 6 weeks
...
{\color{incolor}In [{\color{incolor}7}]:} \PY{c}{\PYZsh{} Metropolis\PYZhy{}Hastings to get a sample for rate of treatment}
        ...
        \PY{k}{print} \PY{n}{array}\PY{p}{(}\PY{n}{percentile}\PY{p}{(}\PY{n}{att\PYZus{}symp}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{2.5}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{,} \PY{l+m+mi}{50}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{,} \PY{l+m+mf}{97.5}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{o}{*}\PY{l+m+mf}{365.25}
...
0.226545454545
14.4054933827
[  8.59839927  11.77758657  13.98780214  16.69605121  22.22498957]
    \end{Verbatim}
...
Median (central 95\% credible interval) for spontaneous clearance rate in men: 
 	0.395824502635 [ 0.05879628  1.27387539]
...
Median (central 95\% credible interval) for spontaneous clearance rate in women:
 	0.725636286054 [ 0.59114145  0.87428941]
    \end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Mean proportion asymptomatic in men: 0.510862240435
Median (central 95\% credible interval) for proportion asymptomatic in men: 
 	0.509889142897 [ 0.26393408  0.75872662]
...
Median (central 95\% credible interval) for proportion asymptomatic in women:
 	0.616465413009 [ 0.46763845  0.75205518]
    \end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c}{\PYZsh{}plt.rc(\PYZdq{}savefig\PYZdq{}, dpi=300) \PYZsh{} for high\PYZhy{}resolution version}
         \PY{c}{\PYZsh{} Figure 4}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}23}]:} <matplotlib.text.Text at 0x1113aed10>
\end{Verbatim}
    \end{footnotesize}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}24}]:} <matplotlib.text.Text at 0x10fd74910>
\end{Verbatim}
    \end{footnotesize}
