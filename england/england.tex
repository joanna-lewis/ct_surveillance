...
by Price \emph{et al.} in \emph{Stat. Med.} \textbf{32}:1547-1560.
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{sc\PYZus{}m} \PY{o}{=} \PY{n}{empty}\PY{p}{(}\PY{n}{n\PYZus{}sample}\PY{p}{)} \PY{c}{\PYZsh{} testing rate per person per year}
        ...
        \PY{n}{sc\PYZus{}f} \PY{o}{=} \PY{n}{empty}\PY{p}{(}\PY{n}{n\PYZus{}sample}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{h}\PY{o}{=}\PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{p\PYZus{}asymp\PYZus{}f}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{l+m+mi}{50}\PY{p}{,} \PY{n}{histtype}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{step}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{normed}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{r}\PY{l+s}{\PYZsq{}}\PY{p}{)}
         ...
         \PY{k}{print} \PY{l+s}{\PYZsq{}}\PY{l+s}{Central 95}\PY{l+s+si}{\PYZpc{} c}\PY{l+s}{redible interval for proportion asymptomatic in men: }\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{ }\PY{l+s+se}{\PYZbs{}t}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PYZbs{}
             \PY{n}{percentile}\PY{p}{(}\PY{n}{p\PYZus{}asymp\PYZus{}m}\PY{p}{,} \PY{p}{(}\PY{l+m+mf}{2.5}\PY{p}{,}\PY{l+m+mf}{97.5}\PY{p}{)}\PY{p}{)}
         \PY{k}{print} \PY{l+s}{\PYZsq{}}\PY{l+s}{Central 95}\PY{l+s+si}{\PYZpc{} c}\PY{l+s}{redible interval for proportion asymptomatic in women:}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{ }\PY{l+s+se}{\PYZbs{}t}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PYZbs{}
             \PY{n}{percentile}\PY{p}{(}\PY{n}{p\PYZus{}asymp\PYZus{}f}\PY{p}{,} \PY{p}{(}\PY{l+m+mf}{2.5}\PY{p}{,}\PY{l+m+mf}{97.5}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
    \end{footnotesize}
