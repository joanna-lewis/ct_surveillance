...
{\color{incolor}In [{\color{incolor}18}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.display} \PY{k+kn}{import} \PY{n}{Image}
...
\end{Verbatim}
    \end{footnotesize}
\begin{footnotesize}
		\texttt{\color{outcolor}Out[{\color{outcolor}18}]:}\texttt{\color{outcolor}Out[{\color{outcolor}18}]:}
    
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{three_compartment_model_files/three_compartment_model_1_0.png}\end{center}
...
\(\alpha_{SU}\):
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{k+kn}{import} \PY{n+nn}{sympy} \PY{k+kn}{as} \PY{n+nn}{sym}
...
\end{Verbatim}
    ...
    \begin{footnotesize}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:} \{S: alpha\_AU*alpha\_US/(alpha\_AU*alpha\_US + alpha\_SU*(alpha\_AU + alpha\_UA)),
...
\item
  ...
  background antibiotic use at a rate 4.74 per year.
\item
...
\end{itemize}
    ...
    \begin{footnotesize}
        \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{p\PYZus{}asymp} \PY{o}{=} \PY{l+m+mf}{0.875}
         \PY{n}{sc} \PY{o}{=} \PY{l+m+mf}{4.74}
